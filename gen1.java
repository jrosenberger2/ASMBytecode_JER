/**
 * gen1.java generates bytecode to multiply two numbers, then store and display the result
...
public class gen1 {
    public static void main(String[] args){
        ...
        //main visitor
        {
            ...
            //Int Section
            //Set String
            setBuilder(mv, "The int product is: ");
            ...
            //Long Section
            //Set String
            setBuilder(mv, "The long product is: ");

            //Declare 2 longs
            mv.visitLdcInsn((Long)55000l);
            mv.visitVarInsn(Opcodes.LSTORE, 5);
            mv.visitLdcInsn((Long)100000l);
            ...
            //Float Section
            //Set String
            setBuilder(mv, "The float product is: ");

            //Declare two floats
            mv.visitLdcInsn((Float)15.45f);
            mv.visitVarInsn(Opcodes.FSTORE, 11);
            mv.visitLdcInsn((Float)113.36f);
            mv.visitVarInsn(Opcodes.FSTORE, 12);

            //Load & Multiply floats
            ...
            //Double Section
            //Set String
            setBuilder(mv, "The double product is: ");

            //Declare two doubles
            mv.visitLdcInsn((Double)2.1654879354);
            mv.visitVarInsn(Opcodes.DSTORE, 14);
            mv.visitLdcInsn((Double)125687.6487987);
            mv.visitVarInsn(Opcodes.DSTORE, 16);

            //Load & multiply doubles
